...
Every table on this page is regenerated by `flymsg compare` (it loads both datasets, so
`flymsg fetch --dataset fafb` and `build` must have run):

| Table                          | Command                                            |
| ------------------------------ | -------------------------------------------------- |
| the density factor             | `flymsg compare`                                   |
| male vs female                 | `flymsg compare --sex --seeds 3`                   |
| subtype fingerprints           | `flymsg compare --fingerprint LB3a LB3b LB3c LB3d` |
| the LB3 split and MN9 per part | `flymsg compare --lb3-split --seeds 10`            |
...
## Male vs female (`flymsg compare --sex`, `runs/sex-comparison.csv`)
...
(`flymsg compare --lb3-split`, `runs/lb3-fafb-split.csv`; median margin between best and
second 0.11):
